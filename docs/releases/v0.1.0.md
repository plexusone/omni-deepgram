...
Initial release of omni-deepgram, an OmniVoice STT provider for Deepgram speech-to-text services.
...
- `github.com/plexusone/omnivoice` v0.2.0 - OmniVoice interfaces
- `github.com/deepgram/deepgram-go-sdk/v3` v3.0.0 - Official Deepgram SDK

## Related

- [omnivoice-examples](https://github.com/plexusone/omnivoice-examples) - Complete voice agent examples combining Deepgram STT with ElevenLabs TTS
